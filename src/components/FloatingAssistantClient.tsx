  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-8 right-8 z-50 h-16 w-16 text-white rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-105 active:scale-95 ${
      ...
      >
        {isOpen ? (
          ...
          <div className="relative h-full w-full">
            <img src="/AI logo.png" alt="AI Assistant Logo" className="h-full w-full object-cover rounded-full" />
          </div>
        )}
      </button>
